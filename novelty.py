...
def main():
    print(f"--- NOVELTY BIAS EXPERIMENT ---")
    ...
    experiments = [
        ("EXP-05", "Raw Ratings", "IPW", 'Y_raw', run_ipw),
        ("EXP-06", "Raw Ratings", "PSM", 'Y_raw', run_psm),
        ("EXP-07", "Normalized", "IPW", 'Y_norm', run_ipw),
        ("EXP-08", "Normalized", "PSM", 'Y_norm', run_psm),
    ]
    ...
    pd.DataFrame(results).to_csv('novelty_bias_results.csv', index=False)
    print("\nSaved to novelty_bias_results.csv")
